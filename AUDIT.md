...
- [x] `src/lib/server/sitemap.ts`'s `toXmlUrl` never emits `<lastmod>` for static routes (only for post nodes) — `/`, `/about`, `/archives`, etc. have no lastmod hint (found: 2026-09-01) (resolved: 2026-09-22, fixed by automated routine)
