...
- [x] `src/routes/api/comment/server.spec.ts` has no test for the content/name/email truncation logic (`+server.ts:36-38`, `.slice(5000/100/254)`) (found: 2026-09-01) (resolved: 2026-09-18, fixed by automated routine)
